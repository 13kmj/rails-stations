...
ActiveRecord::Schema.define(version: 2024_06_16_112212) do
  ...
  create_table "rankings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["movie_id", "rank_date"], name: "index_rankings_on_movie_id_and_rank_date", unique: true
  ...
  create_table "theaters", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", limit: 160, null: false, comment: "劇場名"
    t.string "address", limit: 160, null: false, comment: "劇場の住所"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["address"], name: "index_theaters_on_address"
